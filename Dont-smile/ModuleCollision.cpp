...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_PLAYER][COLLIDER_TURRET] = false;
	...
	matrix[COLLIDER_ENEMY][COLLIDER_TURRET] = false;
	...
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_TURRET] = false;
	...
	matrix[COLLIDER_PLAYER2][COLLIDER_TURRET] = false;
	...
	matrix[COLLIDER_PLAYER2_SHOT][COLLIDER_TURRET] = false;
	...
	matrix[COLLIDER_POWERUP_B][COLLIDER_TURRET] = false;
	...
	matrix[COLLIDER_POWERUP_R][COLLIDER_TURRET] = false;
	...
	matrix[COLLIDER_POWERUP_M][COLLIDER_TURRET] = false;
	...
	matrix[COLLIDER_POWERUP_BLUE][COLLIDER_TURRET] = false;
	...
	matrix[COLLIDER_TURRET][COLLIDER_BOX] = false;
	matrix[COLLIDER_TURRET][COLLIDER_PLAYER] = false;
	matrix[COLLIDER_TURRET][COLLIDER_ENEMY] = false;
	matrix[COLLIDER_TURRET][COLLIDER_PLAYER_SHOT] = false;
	matrix[COLLIDER_TURRET][COLLIDER_ENEMY_SHOT] = false;
	matrix[COLLIDER_TURRET][COLLIDER_EXPLOSION] = true;
	matrix[COLLIDER_TURRET][COLLIDER_PLAYER2] = false;
	matrix[COLLIDER_TURRET][COLLIDER_PLAYER2_SHOT] = false;
	matrix[COLLIDER_TURRET][COLLIDER_POWERUP_B] = false;
	matrix[COLLIDER_TURRET][COLLIDER_POWERUP_R] = false;
	matrix[COLLIDER_TURRET][COLLIDER_POWERUP_M] = false;
	matrix[COLLIDER_TURRET][COLLIDER_POWERUP_BLUE] = false;
	matrix[COLLIDER_TURRET][COLLIDER_TURRET] = false;
	matrix[COLLIDER_TURRET][COLLIDER_BOMB] = false;
	matrix[COLLIDER_TURRET][COLLIDER_BOMB2] = false;
	matrix[COLLIDER_TURRET][COLLIDER_POWERUP_DRAGON] = false;
	matrix[COLLIDER_TURRET][COLLIDER_POWERUP_MEDAL] = false;
	...
	matrix[COLLIDER_BOMB2][COLLIDER_TURRET] = false;
	...
	matrix[COLLIDER_POWERUP_DRAGON][COLLIDER_TURRET] = false;
	...
	matrix[COLLIDER_POWERUP_MEDAL][COLLIDER_TURRET] = false;
...
{
	if (App->input->keyboard[SDL_SCANCODE_C] == KEY_DOWN || App->input->gamepad[7] == KEY_STATE::KEY_REPEAT)
		debug = !debug;
